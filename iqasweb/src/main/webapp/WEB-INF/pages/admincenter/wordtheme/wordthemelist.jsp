	...
	<table class="table table-bordered table-striped"> <!-- table-bordered -->
		<thead>
			<tr>
				...
				<td align="center" width="20%">主题名称</td>
				<td align="center" width="20%">主题包含单词数</td>
		...
		<c:forEach items="${pageView.records }" var="entity">
			<tr>
				...
				<td align="center">
				 ...
				 <span class="glyphicon glyphicon-pencil editClass" aria-hidden="true" onclick="editName('${entity.id}')" ></span>
				 </td>
				<td align="center">
